...
class InvoiceDetailsCard extends StatelessWidget {
  final ReceivePaymentModel invoice;

  const InvoiceDetailsCard({required this.invoice, super.key});
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _infoRow("اسم العميل", invoice.customerName ?? "-"),
                  _infoRow("كود العميل", invoice.customerId ?? "-"),
