...
class SlideBarWidget extends StatelessWidget {
          ...
          children: [
            ...
            InkWell(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => TransactionsListPage(isIncome: true),
                ),
              ),
            ),
            ...
            InkWell(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => TransactionsListPage(isIncome: false),
                ),
              ),
            ),
            ...
            InkWell(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => ReceivedPaymentInvoiceScreen(),
                ),
              ),
            ),
  ...
  void _showAddProductDialog(BuildContext context) => showDialog(
    context: context,
    barrierDismissible: false,
    builder: (_) => AddProductDialog(),
  );

  void _showAddCustomerDialog(BuildContext context) => showDialog(
    context: context,
    barrierDismissible: false,
    builder: (_) => AddCustomerDialog(),
  );

  void _showAddVendorDialog(BuildContext context) => showDialog(
    context: context,
    barrierDismissible: false,
