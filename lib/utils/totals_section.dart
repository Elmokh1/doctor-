...
class TotalsAndDiscountSection extends StatelessWidget {
  ...
  Widget _buildTotalRow(String label, double value, Color color, {bool isGrandTotal = false}) {
    return Padding(
            ...
            children: [
              Row(
                children: [
                  SizedBox(
                    ...
                    child: TextField(
                      ...
                      controller: TextEditingController(
                          text: initialDiscount > 0 ? initialDiscount.toString() : ''),
                  ...
                  Text('enter_discount'.tr(), style: const TextStyle(fontSize: 16)),
                ],
              ),
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildTotalRow('${'subtotal'.tr()}:', subtotal, Colors.black87),
                  const Divider(),
                  _buildTotalRow('${'applied_discount'.tr()}:', -discountAmount, Colors.red),
                  const Divider(thickness: 3, height: 25),
                  _buildTotalRow('${'net_total'.tr()}:', grandTotal, Colors.indigo.shade800,
                      isGrandTotal: true),
                ],
              ),
            ),
